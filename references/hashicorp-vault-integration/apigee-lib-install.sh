...
if [ ! -f "$APIGEE_LIB/message-flow-1.0.0.jar" ]; then
    ...
    curl  --output-dir "$APIGEE_LIB" -LO https://github.com/apigee/api-platform-samples/raw/master/doc-samples/java-hello/lib/message-flow-1.0.0.jar
...
if [ ! -f "$APIGEE_LIB/expressions-1.0.0.jar" ]; then
    ...
    curl  --output-dir "$APIGEE_LIB" -LO https://github.com/apigee/api-platform-samples/raw/master/doc-samples/java-hello/lib/expressions-1.0.0.jar
