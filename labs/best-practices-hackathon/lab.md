...
You may have noticed that our Currency conversion microservice response contains *internal data* related to transaction tracing pattern used in _We Move Your Money Fast_ technology stack.
