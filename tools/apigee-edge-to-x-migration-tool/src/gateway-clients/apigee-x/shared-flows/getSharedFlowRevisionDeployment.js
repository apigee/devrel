 ...
 */
export default async function getSharedFlowRevisionDeployment(apigeeXClient, apigeeEnvironment, sharedFlowName, revision) {
  return apigeeXClient.get(`/environments/${apigeeEnvironment}/sharedflows/${sharedFlowName}/revisions/${revision}/deployments`);
}